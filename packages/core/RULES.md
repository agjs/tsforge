...
- **frontend**: Recommended with React/Next architecture rules at warn.
...
- **react-component-architecture/component-folder-structure** [ERROR]: Enforce required sibling files in component folders (hooks, types, stories, test, index)
