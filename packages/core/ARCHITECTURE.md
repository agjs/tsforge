...
Derived from `packages/core/src`: **30 subsystems**, **598 files**, **112758 lines**, **138 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 129 | 36472 | 8 | 22 |
