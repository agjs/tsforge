...
Derived from `packages/core/src`: **30 subsystems**, **578 files**, **107023 lines**, **136 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 115 | 32916 | 7 | 22 |
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 20 | 7051 | 2 | 18 |
