...
Derived from `packages/core/src`: **30 subsystems**, **610 files**, **114051 lines**, **138 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 138 | 37477 | 8 | 22 |
