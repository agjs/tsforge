...
Derived from `packages/core/src`: **30 subsystems**, **623 files**, **120k lines**, **141 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 143 | 40k | 8 | 22 |
...
| `IGate` | `gate/gate-runner.ts:25` | 16 |
