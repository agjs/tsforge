...
Derived from `packages/core/src`: **30 subsystems**, **616 files**, **116374 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 140 | 38649 | 8 | 22 |
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7517 | 2 | 18 |
...
| `config` | tsforge.config.json, profiles, recipes, agent specs, and external plugins | core | 12 | 2624 | 8 | 8 |
