...
Derived from `packages/core/src`: **30 subsystems**, **631 files**, **125k lines**, **141 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 151 | 42k | 8 | 22 |
