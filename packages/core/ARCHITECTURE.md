...
Derived from `packages/core/src`: **30 subsystems**, **618 files**, **116702 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 142 | 38873 | 8 | 22 |
