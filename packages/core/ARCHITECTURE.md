...
Derived from `packages/core/src`: **30 subsystems**, **577 files**, **106549 lines**, **136 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 114 | 32564 | 7 | 22 |
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 20 | 6991 | 2 | 18 |
...
| `agent` | Tool schemas, the model-as-agent wrapper, and the malformed-tool-call repair ladder | core | 10 | 2707 | 8 | 9 |
...
| `policy` | Decides which actions are allowed in the current mode before they run | core | 5 | 1256 | 5 | 3 |
