...
Derived from `packages/core/src`: **30 subsystems**, **587 files**, **111422 lines**, **137 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 121 | 35655 | 8 | 22 |
