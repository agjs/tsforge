...
Derived from `packages/core/src`: **30 subsystems**, **547 files**, **98260 lines**, **134 cross-subsystem edges**.
...
| `self-harness` | Lets the harness propose, trial, and keep edits to its own prompts and rules | optional | 15 | 3361 | 2 | 9 |
...
| `policy` | Decides which actions are allowed in the current mode before they run | core | 5 | 1198 | 5 | 3 |
