...
Derived from `packages/core/src`: **30 subsystems**, **586 files**, **110832 lines**, **137 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 121 | 35432 | 8 | 22 |
