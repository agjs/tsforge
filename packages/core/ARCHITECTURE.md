...
Derived from `packages/core/src`: **30 subsystems**, **580 files**, **108061 lines**, **136 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 116 | 33519 | 7 | 22 |
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 164 | 19000 | 3 | 3 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 40 | 9564 | 7 | 5 |
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 21 | 7201 | 2 | 18 |
