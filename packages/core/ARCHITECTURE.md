...
Derived from `packages/core/src`: **30 subsystems**, **626 files**, **123k lines**, **141 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 146 | 41k | 8 | 22 |
