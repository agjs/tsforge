...
Derived from `packages/core/src`: **30 subsystems**, **547 files**, **98057 lines**, **134 cross-subsystem edges**.
...
| `architecture` ⚠️ | Derives this map from source so the docs cannot drift from the code | optional | 8 | 1099 | 0 | 0 |
