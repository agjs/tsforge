...
Derived from `packages/core/src`: **30 subsystems**, **617 files**, **116544 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 141 | 38768 | 8 | 22 |
...
| `agent` | Tool schemas, the model-as-agent wrapper, and the malformed-tool-call repair ladder | core | 10 | 3103 | 8 | 9 |
