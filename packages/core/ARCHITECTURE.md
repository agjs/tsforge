...
Derived from `packages/core/src`: **30 subsystems**, **612 files**, **114385 lines**, **139 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 138 | 37497 | 8 | 22 |
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 166 | 19543 | 3 | 3 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 41 | 9778 | 7 | 5 |
...
| `gate` | Composes and runs the deterministic gate: linter, stages, tool paths | core | 12 | 1438 | 5 | 6 |
