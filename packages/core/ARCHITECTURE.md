...
Derived from `packages/core/src`: **30 subsystems**, **586 files**, **110791 lines**, **137 cross-subsystem edges**.
...
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 164 | 19019 | 3 | 3 |
