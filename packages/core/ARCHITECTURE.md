...
Derived from `packages/core/src`: **30 subsystems**, **621 files**, **118k lines**, **140 cross-subsystem edges**.
...
| `agent` | Tool schemas, the model-as-agent wrapper, and the malformed-tool-call repair ladder | core | 11 | 3k | 8 | 9 |
