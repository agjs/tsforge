...
Derived from `packages/core/src`: **30 subsystems**, **590 files**, **111861 lines**, **138 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 122 | 35804 | 8 | 22 |
