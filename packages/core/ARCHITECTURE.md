...
Derived from `packages/core/src`: **30 subsystems**, **616 files**, **115877 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 140 | 38168 | 8 | 22 |
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7512 | 2 | 18 |
