...
Derived from `packages/core/src`: **30 subsystems**, **614 files**, **115054 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 138 | 37676 | 8 | 22 |
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 166 | 19543 | 3 | 3 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 42 | 9830 | 7 | 5 |
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7448 | 2 | 18 |
...
| `gate` | Composes and runs the deterministic gate: linter, stages, tool paths | core | 13 | 1797 | 5 | 7 |
