...
Derived from `packages/core/src`: **30 subsystems**, **616 files**, **116109 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 140 | 38385 | 8 | 22 |
