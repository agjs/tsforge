...
Derived from `packages/core/src`: **30 subsystems**, **670 files**, **131k lines**, **143 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 158 | 43k | 8 | 22 |
...
| `IConventionProvider` | `loop/conventions-provider.ts:10` | 16 |
| `IPlanSchema` | `loop/planning/plan-types.ts:45` | 7 |
| `IGate` | `gate/gate-runner.ts:25` | 20 |
| `IProductPlan` | `loop/planning/plan-types.ts:32` | 7 |
