...
Derived from `packages/core/src`: **30 subsystems**, **610 files**, **113860 lines**, **138 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 138 | 37333 | 8 | 22 |
...
| `config` | tsforge.config.json, profiles, recipes, agent specs, and external plugins | core | 12 | 2521 | 7 | 8 |
