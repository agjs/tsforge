...
Derived from `packages/core/src`: **30 subsystems**, **615 files**, **115244 lines**, **140 cross-subsystem edges**.
...
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 42 | 9836 | 7 | 5 |
