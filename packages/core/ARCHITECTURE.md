...
Derived from `packages/core/src`: **30 subsystems**, **627 files**, **124k lines**, **141 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 147 | 42k | 8 | 22 |
