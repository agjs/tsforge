...
Derived from `packages/core/src`: **30 subsystems**, **623 files**, **119k lines**, **141 cross-subsystem edges**.
...
| `gate` | Composes and runs the deterministic gate: linter, stages, tool paths | core | 14 | 2k | 5 | 8 |
