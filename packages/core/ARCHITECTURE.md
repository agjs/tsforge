...
Derived from `packages/core/src`: **30 subsystems**, **587 files**, **111141 lines**, **137 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 121 | 35509 | 8 | 22 |
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 164 | 19123 | 3 | 3 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 41 | 9669 | 7 | 5 |
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 21 | 7330 | 2 | 18 |
...
| `eval` | Run scoring, failure classification, and the quality judge | optional | 10 | 1904 | 4 | 4 |
