...
Derived from `packages/core/src`: **30 subsystems**, **632 files**, **125k lines**, **141 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 152 | 43k | 8 | 22 |
