...
Derived from `packages/core/src`: **30 subsystems**, **586 files**, **110826 lines**, **137 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 121 | 35426 | 8 | 22 |
