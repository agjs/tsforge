...
Derived from `packages/core/src`: **30 subsystems**, **547 files**, **98307 lines**, **134 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 105 | 30326 | 7 | 21 |
...
| `policy` | Decides which actions are allowed in the current mode before they run | core | 5 | 1240 | 5 | 3 |
