...
Derived from `packages/core/src`: **30 subsystems**, **612 files**, **114714 lines**, **139 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 138 | 37599 | 8 | 22 |
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 166 | 19543 | 3 | 3 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 41 | 9777 | 7 | 5 |
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7396 | 2 | 18 |
...
| `config` | tsforge.config.json, profiles, recipes, agent specs, and external plugins | core | 12 | 2568 | 7 | 8 |
...
| `gate` | Composes and runs the deterministic gate: linter, stages, tool paths | core | 12 | 1656 | 5 | 6 |
