...
Derived from `packages/core/src`: **30 subsystems**, **580 files**, **107850 lines**, **136 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 116 | 33504 | 7 | 22 |
