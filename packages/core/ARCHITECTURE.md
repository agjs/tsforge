...
Derived from `packages/core/src`: **30 subsystems**, **570 files**, **102124 lines**, **136 cross-subsystem edges**.
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7240 | 2 | 19 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 35 | 6321 | 6 | 5 |
...
| --- | --- | --- |
| `(root)` ↔ `cli` | `cli.ts:22` → `./cli/worklist-deps` | `cli/banner.ts:6` → `../session-store` |
