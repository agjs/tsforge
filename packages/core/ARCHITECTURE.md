...
Derived from `packages/core/src`: **30 subsystems**, **586 files**, **111032 lines**, **137 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 121 | 35438 | 8 | 22 |
