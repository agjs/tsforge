...
Derived from `packages/core/src`: **30 subsystems**, **586 files**, **111131 lines**, **137 cross-subsystem edges**.
...
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 40 | 9659 | 7 | 5 |
