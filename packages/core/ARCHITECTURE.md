...
Derived from `packages/core/src`: **30 subsystems**, **618 files**, **116691 lines**, **140 cross-subsystem edges**.
...
| `policy` | Decides which actions are allowed in the current mode before they run | core | 5 | 1277 | 5 | 3 |
