...
Derived from `packages/core/src`: **30 subsystems**, **615 files**, **115493 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 139 | 37868 | 8 | 22 |
...
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7457 | 2 | 18 |
...
| `config` | tsforge.config.json, profiles, recipes, agent specs, and external plugins | core | 12 | 2595 | 8 | 8 |
...
| `(root)` | CLI entry, model registry, session persistence — the loose files in src/ | core | 6 | 2339 | 5 | 15 |
