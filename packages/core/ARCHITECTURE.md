...
Derived from `packages/core/src`: **30 subsystems**, **686 files**, **134k lines**, **144 cross-subsystem edges**.
...
| `mcp` | Model Context Protocol client that exposes external servers as tools | optional | 8 | <1k | 3 | 1 |
