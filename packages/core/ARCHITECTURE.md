...
Derived from `packages/core/src`: **30 subsystems**, **618 files**, **116769 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 142 | 38886 | 8 | 22 |
...
| `eval` | Run scoring, failure classification, and the quality judge | optional | 10 | 1961 | 4 | 4 |
