...
Derived from `packages/core/src`: **30 subsystems**, **612 files**, **114648 lines**, **139 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 138 | 37533 | 8 | 22 |
