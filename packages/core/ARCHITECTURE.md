...
Derived from `packages/core/src`: **30 subsystems**, **578 files**, **107071 lines**, **136 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 115 | 32957 | 7 | 22 |
