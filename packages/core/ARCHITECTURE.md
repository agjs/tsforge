...
Derived from `packages/core/src`: **30 subsystems**, **615 files**, **115256 lines**, **140 cross-subsystem edges**.
...
| --- | --- | --- | --- | --- | --- | --- |
| `loop` | The drive-to-green engine: turns, tools, gate settling, steering, adapters | core | 139 | 37786 | 8 | 22 |
| `rule-packs` | The ESLint rule packs the gate enforces, grouped by stack | core | 166 | 19543 | 3 | 3 |
| `render` | Terminal UI — status bar, menus, wizards, markdown, diffs, spinners | core | 42 | 9848 | 7 | 5 |
| `cli` | Argument parsing, the interactive REPL, and per-mode wiring | core | 22 | 7453 | 2 | 18 |
...
| `config` | tsforge.config.json, profiles, recipes, agent specs, and external plugins | core | 12 | 2568 | 8 | 8 |
...
| `(root)` | CLI entry, model registry, session persistence — the loose files in src/ | core | 6 | 2333 | 5 | 15 |
...
| `gate` | Composes and runs the deterministic gate: linter, stages, tool paths | core | 13 | 1866 | 5 | 7 |
