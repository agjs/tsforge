...
description: Configure any OpenAI-compatible model — a local vLLM model, DeepSeek, OpenAI o-series, or a custom gateway — from one registry file. No env vars needed.
---
