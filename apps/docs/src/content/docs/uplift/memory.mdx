...
## Product decisions across days

This page is **coding lessons** (TTSR). For remembering product and architecture choices across sessions via a backend you host (Hindsight, MCP, etc.), see [Decision memory](/integrations/decision-memory/).

→ [Stop bad output early (TTSR)](/uplift/ttsr/) · [Decision memory](/integrations/decision-memory/) · [When the gate fails](/loop/validation/) · [Interactive CLI](/cli/interactive/)
