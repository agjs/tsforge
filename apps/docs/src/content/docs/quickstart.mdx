...
You give it a task; the model edits; the gate decides done. For the full architecture (the general core, the adapters at the seams, and the request flow), see [Big picture](/big-picture/).
...
| Building a Phaser 4 game | [Phaser scaffolding](/scaffold/phaser/) |
